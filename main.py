...
def main(args):
    ...
    if args.eval:
        ...
        if args.output_dir and utils.is_main_process():
            with open(output_dir / "coco_summary.txt", "w") as summary_file:
                with contextlib.redirect_stdout(summary_file):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        ## COMMENTING OUT ALL MODEL SAVING
        # if args.output_dir:
        ...
        print("IS BEST: ", _isbest)
        print("EPOCH NUMBER: ", epoch)
        if _isbest or epoch == 0:
