...
max_text_len = 256
text_encoder_type = '/cluster/tufts/cs152l3dclass/mprete01/Medical-Grounding-DINO/vanilla-weights/medbert_weights'
...
use_coco_eval = False
label_list = [
    'boneanomaly', 'bonelesion', 'fracture', 'metal', 'periostealreaction',
