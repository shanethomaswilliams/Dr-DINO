...
max_text_len = 256
text_encoder_type = "/cluster/tufts/cs152l3dclass/mprete01/Medical-Grounding-DINO/vanilla-weights/bert_weights"
...
use_coco_eval = False
label_list = ["aortic enlargement", "atelectasis", "calcification", "cardiomegaly", "consolidation", "ILD", "infiltration", "lung opacity", "nodule/mass", "other lesion", "pleural effusion", "pleural thickening", "pneumothorax", "pulmonary fibrosis", "no findings"]
